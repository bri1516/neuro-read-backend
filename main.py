...
async def generar_ejercicio(datos: PeticionEjercicio):
    ...
    model = genai.GenerativeModel('gemini-1.5-flash-latest', generation_config={"temperature": 0.85})
...
async def analizar_ejercicio(datos: PeticionAnalisis):
    ...
    model = genai.GenerativeModel('gemini-1.5-flash-latest', generation_config={"temperature": 0.3})
